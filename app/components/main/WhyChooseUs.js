    ...
    return (
        <>
            <section className="py-10 px-6 bg-white text-center">
                <h2 className="text-xl md:text-2xl font-bold">Why <span className='text-[var(--greenPanel)]'>Happy</span>Invoice?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <div className='bg-[var(--greenLightest2Panel)] rounded-lg px-3 pb-4 pt-8'>
                        <i className="fa-solid fa-bolt text-4xl text-[var(--greenPanel)]"></i>
                    ...
                    <div className='bg-[var(--greenLightest2Panel)] rounded-lg px-3 pb-4 pt-8'>
                        <i className="fa-solid fa-shield-halved text-4xl text-[var(--greenPanel)]"></i>
                    ...
                    <div className='bg-[var(--greenLightest2Panel)] rounded-lg px-3 pb-4 pt-8'>
                        <i className="fa-solid fa-rocket text-4xl text-[var(--greenPanel)]"></i>
